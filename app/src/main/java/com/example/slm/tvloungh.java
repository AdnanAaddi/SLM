...
public class tvloungh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvloungh);
    ...
    public void clickbulb(View v) {
        ...
        Toast.makeText(tvloungh.this,"Bulb ONN!",Toast.LENGTH_SHORT).show();
    ...
    public void clickfillbulb(View v){
        ...
        Toast.makeText(tvloungh.this,"Bulb OFF!",Toast.LENGTH_SHORT).show();
    ...
    public void clickmotion(View v) {
        ...
        Toast.makeText(tvloungh.this,"Motion sensor start!",Toast.LENGTH_SHORT).show();
    ...
    public void clickfillmotion(View v){
        ...
        Toast.makeText(tvloungh.this,"Motion sensor stop!",Toast.LENGTH_SHORT).show();
    ...
    public void fan(View v) {
        ...
        Toast.makeText(tvloungh.this,"Fan ON!",Toast.LENGTH_SHORT).show();
    ...
    public void fanfill(View v){
        ...
        Toast.makeText(tvloungh.this,"Fan OFF!",Toast.LENGTH_SHORT).show();
    ...
    public void temp(View v) {
        ...
        Toast.makeText(tvloungh.this,"Temperature sensor start!",Toast.LENGTH_SHORT).show();
    ...
    public void tempfill(View v){
        ...
        Toast.makeText(tvloungh.this,"Temperature sensor stop!",Toast.LENGTH_SHORT).show();

    }
    public void back(View view) {
        Toast.makeText(tvloungh.this,"Back to home!",Toast.LENGTH_SHORT).show();

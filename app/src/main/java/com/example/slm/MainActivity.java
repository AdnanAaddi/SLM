...
public class MainActivity extends AppCompatActivity {
    ...
    public void washroom(View v){
        ...
        Intent i= new Intent(MainActivity.this, washroom.class);
        startActivity(i);
    ...
    public void tvloungh(View v){

        Intent i= new Intent(MainActivity.this, tvloungh.class);
        startActivity(i);
